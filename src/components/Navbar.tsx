  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-[#03303A] text-white shadow-xl py-2.5'
          : 'bg-white text-slate-800 border-b border-slate-100 py-3 md:py-4'
      }`}
    >
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <img 
              ...
              className={`h-12 sm:h-16 lg:h-20 max-h-[72px] w-auto object-contain transition-all duration-300 ${
